# HAAG Open House / Project Showcase (Surveys) Procedure
To be created and sent by one or two managers or admins. HAAG seems to be using Georgia Tech's Qualtrics platform for surveys. It is recommended to use this system to stay consistent, but with approval you can try using another tool such as Google Forms.
...
2. How did you first hear about HAAG?
   ...
   -  HAAG Website
   -  Other _____
3. Did you attend the HAAG Open House event, or watch the videos online?
   -  Yes
   -  No
4. How familiar do you feel about various aspects of HAAG? (5 being the most)
   -  Active Research Projects (1 to 5)
   -  HAAG Org Structure (1 to 5)
   -  HAAG Internal Processes (1 to 5)
5. Do you intend to apply to HAAG Research as a researcher?
   -  Yes
   -  Maybe
   -  No
